...
class RRT:
    ...
    def __init__(self, q_start, p_goal, kin_solver, side, joint_names, obstacles):
        self.kin = kin_solver
    ...
    def extend_toward_goal(self, dist_thresh=0.02):
        ...
        while first or prev_dist_to_goal > dist_thresh:
            ...
            print "got jacobian soln, but is it collision free?"
    ...
    def ik_extend_randomly(self, curr_pos, dist_thresh, offset=0.75):
        ...
        while prev_dist_to_goal > dist_thresh:
            ...
            if self._check_collision(next_point, 0.1):
                ...
                if solved:
                    print "got random ik soln, but is it collision free?"
                    if self.collision_free(q_new):
                        curr_dist_to_goal = self._dist_to_goal(self.fwd_kin(q_new))
                        curr_pos = next_point
